    ...
    const lisPokemons = pokemons.reduce((accumulator, pokemon) => {
      ...
      accumulator += `
        ...
        pokemon.id
          ...
          <button class="flex text-center justify-center accordion w-full  bg-green-600 rounded text-white shadow-lg hover:bg-green-800"><span><img src="./src/assets/icon.png" class="w-5 mr-5"/> </span>Detalhes</button>
